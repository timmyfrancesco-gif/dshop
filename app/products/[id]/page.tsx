          ...
          <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-2">
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <span className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-casino-from to-accent px-4 py-2.5 shadow-[0_14px_30px_rgba(216,141,248,0.3),inset_0_1px_0_rgba(255,255,255,0.35)]">
