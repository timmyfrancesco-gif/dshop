            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
              ...
              <div className="mt-6 flex flex-col gap-3">
                <Link
                  ...
                  className="rounded-xl bg-gradient-to-r from-[#D88DF8] to-[#38bdf8] px-6 py-3 text-sm font-bold transition-all hover:opacity-90"
                >
                  Visit Your Shop
                </Link>
                <Link
              ...
              {step === 1 && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-gradient-to-r from-[#D88DF8] to-[#38bdf8] py-3 text-sm font-bold transition-all hover:opacity-90"
                  >
                    Continue
                  </button>
                </motion.div>
                ...
                >
                    ...
                    {form.shopLogo ? (
                      <div className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4">
                        ...
                        <img
                          src={form.shopLogo}
                          alt="Logo"
                          className="h-16 w-16 rounded-full object-cover ring-2 ring-[#D88DF8]/50"
                        />
                      ...
                      <button
                        ...
                        disabled={uploading}
                        className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-dashed border-white/20 bg-white/5 px-4 py-8 text-sm text-white/50 transition-all hover:border-[#D88DF8]/50 hover:text-white/70 disabled:opacity-50"
                      >
                        {uploading ? (
                          <span>Uploading...</span>
                        ) : (
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 rounded-xl bg-gradient-to-r from-[#D88DF8] to-[#38bdf8] py-3 text-sm font-bold transition-all hover:opacity-90 disabled:opacity-50"
                    >
